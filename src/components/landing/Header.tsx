...
const fenixLogo = "https://aetxomsehqbuhpotkkdy.supabase.co/storage/v1/object/public/brand-assets/fenix-logo.png";
...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[hsl(0,0%,96%)] backdrop-blur-xl border-b border-border/50">
