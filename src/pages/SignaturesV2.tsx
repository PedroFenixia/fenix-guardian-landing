...
const SignatureTemplate = ({ name, role, email, phone, linkedin, photo }: SignatureProps) => {
  ...
  // Logo URL - using production domain for email clients (same as header logo with white background)
  const logoUrl = "https://fenixia.tech/assets/fenix-header-logo.png";
