    ...
    <td style="padding-left: 22px; padding-right: 24px; vertical-align: middle;">
      <table cellpadding="0" cellspacing="0" border="0" style="margin: auto 0;">
        <tr>
          ...
          <td style="padding-left: 0; padding-bottom: 4px; vertical-align: middle;">
          ...
          >
            <tbody>
              <tr>
                  ...
                  <table cellPadding={0} cellSpacing={0} border={0}>
                    <tbody>
                      <tr>
                        ...
                        <td style={{ paddingLeft: 0, paddingBottom: 4, verticalAlign: "middle" }}>
                          <a 
                ...
                <td style={{ paddingLeft: 16, paddingRight: 16, verticalAlign: "middle", textAlign: "center", width: 100, height: "100%" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%" }}>
                    <img
                      src={qrCodeUrl}
