...
const SignatureTemplate = ({ name, role, email, phone, linkedin, photo }: SignatureProps) => {
  ...
  const signatureHtml = `
<table cellpadding="0" cellspacing="0" border="0" style="font-family: 'Segoe UI', Arial, sans-serif; font-size: 14px; line-height: 1.5; background-color: #272A2C; padding: 24px 28px; border-radius: 12px; width: 100%; max-width: 720px; border: 1px solid rgba(21, 240, 255, 0.2); box-shadow: 0 4px 20px rgba(21, 240, 255, 0.1), 0 1px 3px rgba(0, 0, 0, 0.3);">
  <tr>
    <td style="padding-left: 12px; padding-right: 12px; border-right: 1px solid rgba(255, 255, 255, 0.15); vertical-align: middle; text-align: center; width: 110px; background-color: #272A2C;">
    ...
    <td style="padding-left: 22px; padding-right: 24px; vertical-align: middle; background-color: #272A2C;">
    ...
    <td style="padding-left: 24px; padding-right: 18px; vertical-align: middle; text-align: center; width: 160px; background-color: #272A2C;">
      <img src="${logoUrl}" alt="Fenix IA" width="140" height="140" style="display: block; margin: auto; background-color: #272A2C;" />
    </td>
  </tr>
</table>
  `.trim();
          ...
          >
            <tbody>
              <tr>
                ...
                <td style={{ paddingLeft: 22, paddingRight: 24, verticalAlign: "middle", backgroundColor: "#272A2C" }}>
                  <table cellPadding={0} cellSpacing={0} border={0}>
                    <tbody>
                      <tr>
                ...
                <td style={{ paddingLeft: 24, paddingRight: 18, verticalAlign: "middle", textAlign: "center", width: 160, backgroundColor: "#272A2C" }}>
                  <img
                    src={logoUrl}
                    alt="Fenix IA"
                    width={140}
                    height={140}
                    style={{ display: "block", margin: "auto", backgroundColor: "#272A2C" }}
                  />
                </td>
              </tr>
            </tbody>
